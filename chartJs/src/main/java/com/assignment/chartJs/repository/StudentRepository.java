...
public interface StudentRepository extends JpaRepository<Student, Integer>{
		...
		@Query(value = "SELECT name, gender, level, track, Lecture.title, Score.value " +
					    "FROM Student " +
					    ...
					    "ORDER BY level, track", nativeQuery = true)
			List<Student[]> getStudentsByLevel(@Param("level") byte level);
